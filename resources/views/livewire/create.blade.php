<div class="card">
    <div class="card-body">
        ...
        <form class="w-full max-w-sm">
            ...
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
                    <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="cover_image_filepath">
                        Cover Image
                    </label>
                </div>
                <div class="md:w-2/3">
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 @error('cover_image_filepath') is-invalid @enderror" id="cover_image_filepath" type="file" wire:model="cover_image_filepath">
            ...
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <button wire:click.prevent="storeBook()" wire:loading.attr="disabled" wire:target="cover_image_filepath" class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                        Save
                    </button>
